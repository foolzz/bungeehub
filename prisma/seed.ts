...
async function main() {
  ...
  const hub1 = await prisma.hub.create({
    data: {
      hostId: hubHost1.id,
      name: 'Downtown Richmond Hill Hub',
  ...
  const hub2 = await prisma.hub.create({
    data: {
      hostId: hubHost2.id,
      name: 'Oak Ridges Hub',
      address: '13225 Yonge St, Richmond Hill, ON L4E 1Z2',
      latitude: 43.9545,
      longitude: -79.4277,
      capacity: 75,
      status: HubStatus.ACTIVE,
  ...
  const hub3 = await prisma.hub.create({
    data: {
      hostId: hubHost3.id,
      name: 'Bayview Hub',
      address: '275 Bayview Ave, Richmond Hill, ON L4B 3M5',
      latitude: 43.8456,
      longitude: -79.3712,
      capacity: 50,
      status: HubStatus.ACTIVE,
  ...
  const hub4 = await prisma.hub.create({
    data: {
      hostId: hubHost1.id,
      name: 'Leslie Hub',
      address: '11160 Leslie St, Richmond Hill, ON L4S 0C9',
      latitude: 43.8678,
      longitude: -79.3889,
      capacity: 60,
  ...
  const package1 = await prisma.package.create({
    data: {
      ...
      recipientPhone: '+14165550201',
      deliveryAddress: '234 Yonge St, Richmond Hill, ON L4C 1W6',
      deliveryLatitude: 43.8756,
      deliveryLongitude: -79.4456,
  ...
  const package2 = await prisma.package.create({
    data: {
      ...
      recipientPhone: '+14165550202',
      deliveryAddress: '156 Bayview Ave, Richmond Hill, ON L4B 2Z2',
      deliveryLatitude: 43.8512,
      deliveryLongitude: -79.3778,
  ...
  const package3 = await prisma.package.create({
    data: {
      ...
      recipientName: 'Alice Johnson',
      recipientPhone: '+14165550201',
      deliveryAddress: '89 Major Mackenzie Dr, Richmond Hill, ON L4C 1P2',
      deliveryLatitude: 43.8690,
      deliveryLongitude: -79.4123,
