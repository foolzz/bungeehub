# BungeeHub Host Mobile App

Mobile application for BungeeHub delivery hosts to manage package deliveries, scan barcodes, submit proof of delivery, and optimize delivery routes.
...
// For production
// export const API_BASE_URL = 'https://api.bungeehub.com';
```
...
The app communicates with the BungeeHub backend API. Ensure your backend is running and accessible.
